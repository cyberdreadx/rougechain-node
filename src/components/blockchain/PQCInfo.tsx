...
const algorithms = [
  {
    ...
    description: "Lattice-based signatures (FIPS 204, formerly CRYSTALS-Dilithium) resistant to Shor's algorithm",
  ...
  },
  {
    ...
    description: "Module-LWE key exchange (FIPS 203, formerly CRYSTALS-Kyber) for encrypted messaging",
  ...
  },
  {
    ...
    description: "256-bit hashing for addresses and block integrity; ~128-bit security under Grover's algorithm",
    keySize: "256-bit",
    sigSize: "32-byte digest",
    status: "FIPS 180-4",
    icon: Atom,
  },
];
