...
const Messenger = () => {
  ...
  return (
    <div className="flex flex-col overflow-hidden h-[calc(100dvh-3.5rem)] md:h-dvh max-w-full">
      ...
      {/* Action Bar */}
      <div className="sticky top-0 z-40 flex items-center justify-between px-2 sm:px-4 py-2 bg-background/80 backdrop-blur-sm border-b border-border gap-1 overflow-x-hidden">
