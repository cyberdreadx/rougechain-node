...
export interface TestXRGEInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface TestXRGE extends BaseContract {
  connect(runner?: ContractRunner | null): TestXRGE;
  waitForDeployment(): Promise<this>;

  interface: TestXRGEInterface;
  ...
  filters: {
    ...
    "BridgeBurn(address,uint256,string)": TypedContractEvent<
      BridgeBurnEvent.InputTuple,
      BridgeBurnEvent.OutputTuple,
      BridgeBurnEvent.OutputObject
    >;
